      ...
      <div className="lg:grid lg:grid-cols-[1fr_380px] lg:gap-12">
        ...
        <div className="mt-8 lg:mt-0">
          <div className="bg-[#FAFAFA] p-6 lg:sticky lg:top-[120px]">
            ...
            <Link
              href="/checkout"
              className="flex items-center justify-center gap-2 w-full h-13 mt-6 bg-accent text-[#FFFFFF] text-[14px] tracking-wide font-semibold hover:bg-accent/90 transition-colors shadow-md"
            >
              Passer commande
              <ArrowRight size={16} strokeWidth={1.5} />
            </Link>
